...
const LOCALES = {
  en: {
    ...
    model_custom_placeholder: 'e.g. openrouter/free',
    model_custom_apply: 'Apply custom model',
    model_custom_or_label: 'Or enter a custom model ID',
    // commands.js
    ...
    revealed: 'Opened',
    reveal_failed: 'Failed to open: ',
    reveal_no_filemanager: 'No file manager available — opening in-browser viewer',
    dir_viewer_title: 'Directory Browser',
    dir_viewer_empty: '(empty directory)',
    host_path_label: 'Host path (Docker volume mapping)',
    copy_host_path: 'Copy host path',
    open_host_dir: 'Open folder',
    open_host_dir_title: 'Open this folder in host file explorer',
    host_path_copied_fallback: 'Path copied — paste in file explorer address bar if auto-open failed',
  ...
  es: {
    ...
    model_custom_placeholder: 'ej: openrouter/free',
    model_custom_apply: 'Aplicar modelo personalizado',
    model_custom_or_label: 'O introduce un ID de modelo personalizado',
    // commands.js
    ...
    reveal_in_explorer: 'Mostrar en el explorador',
    revealed: 'Abierto',
    reveal_failed: 'Error al abrir: ',
    dir_viewer_title: 'Explorador de directorios',
    dir_viewer_empty: '(directorio vacío)',
    host_path_label: 'Ruta del host (mapeo de volumen Docker)',
    copy_host_path: 'Copiar ruta del host',
    open_host_dir: 'Abrir carpeta',
    open_host_dir_title: 'Abrir esta carpeta en el explorador del host',
    host_path_copied_fallback: 'Ruta copiada — péguela en el explorador si no se abrió automáticamente',
  ...
  de: {
    ...
    model_custom_placeholder: 'z.B. openrouter/free',
    model_custom_apply: 'Benutzerdefiniertes Modell anwenden',
    model_custom_or_label: 'Oder benutzerdefinierte Modell-ID eingeben',
    // commands.js
    ...
    revealed: 'Geöffnet',
    reveal_failed: 'Öffnen fehlgeschlagen: ',
    dir_viewer_title: 'Verzeichnis-Browser',
    dir_viewer_empty: '(leeres Verzeichnis)',
    host_path_label: 'Host-Pfad (Docker-Volume-Mapping)',
    copy_host_path: 'Host-Pfad kopieren',
    open_host_dir: 'Ordner öffnen',
    open_host_dir_title: 'Diesen Ordner im Host-Dateimanager öffnen',
    host_path_copied_fallback: 'Pfad kopiert — in den Dateimanager einfügen, falls nicht automatisch geöffnet',
  ...
  zh: {
    ...
    model_custom_placeholder: '\u5982 openrouter/free',
    model_custom_apply: '\u5e94\u7528\u81ea\u5b9a\u4e49\u6a21\u578b',
    model_custom_or_label: '\u6216\u8f93\u5165\u81ea\u5b9a\u4e49\u6a21\u578b ID',
    // commands.js
    cmd_help: '\u67e5\u770b\u53ef\u7528\u547d\u4ee4',
    cmd_clear: '\u6e05\u7a7a\u5f53\u524d\u5bf9\u8bdd\u6d88\u606f',
    cmd_compact: '\u538b\u7f29\u5bf9\u8bdd\u4e0a\u4e0b\u6587',
    ...
    deleted: '\u5df2\u5220\u9664 ',
    delete_failed: '\u5220\u9664\u5931\u8d25\uff1a',
    reveal_in_explorer: '\u5728\u8d44\u6e90\u7ba1\u7406\u5668\u4e2d\u6253\u5f00',
    revealed: '\u5df2\u6253\u5f00',
    reveal_failed: '\u6253\u5f00\u5931\u8d25\uff1a',
    reveal_no_filemanager: '无可用的文件管理器，已打开网页浏览',
    dir_viewer_title: '目录浏览',
    dir_viewer_empty: '(空目录)',
    host_path_label: '宿主机路径 (Docker卷映射)',
    copy_host_path: '复制宿主机路径',
    open_host_dir: '打开目录',
    open_host_dir_title: '在宿主机资源管理器中打开此目录',
    host_path_copied_fallback: '已复制路径，若未自动打开请在资源管理器地址栏粘贴',
  ...
  'zh-Hant': {
    ...
    model_custom_placeholder: '\u5982 openrouter/free',
    model_custom_apply: '\u5957\u7528\u81ea\u8a02\u6a21\u578b',
    model_custom_or_label: '\u6216\u8f38\u5165\u81ea\u8a02\u6a21\u578b ID',
    // commands.js
    cmd_help: '\u67e5\u770b\u53ef\u7528\u547d\u4ee4',
    cmd_clear: '\u6e05\u7a7a\u7576\u524d\u5c0d\u8a71\u8a0a\u606f',
    cmd_compact: '\u58d3\u7e2e\u5c0d\u8a71\u4e0a\u4e0b\u6587',
    ...
    deleted: '\u5df2\u522a\u9664 ',
    delete_failed: '\u522a\u9664\u5931\u6557\uff1a',
    reveal_in_explorer: '\u5728\u6a94\u6848\u7e3d\u7ba1\u4e2d\u958b\u555f',
    revealed: '\u5df2\u958b\u555f',
    reveal_failed: '\u958b\u555f\u5931\u6557\uff1a',
    dir_viewer_title: '目錄瀏覽',
    dir_viewer_empty: '(空目錄)',
    host_path_label: '宿主機路徑 (Docker卷映射)',
    copy_host_path: '複製宿主機路徑',
    open_host_dir: '打開目錄',
    open_host_dir_title: '在宿主機資源管理器中打開此目錄',
    host_path_copied_fallback: '已複製路徑，若未自動打開請在資源管理器地址欄貼上',
    new_file_prompt: '\u65b0\u6587\u4ef6\u540d\uff08\u4f8b\u5982 notes.md\uff09\uff1a',
    created: '\u5df2\u5275\u5efa ',
    create_failed: '\u5275\u5efa\u5931\u6557\uff1a',
